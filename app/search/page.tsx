  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="border-b-2 border-ink pb-6 mb-8">
        <h1 className="font-serif font-black text-ink text-3xl mb-5">
        ...
        <form method="GET" action="/search" className="flex gap-0 max-w-xl">
          ...
          <button
            type="submit"
            className="px-5 py-2.5 bg-ink text-white text-sm font-semibold hover:bg-stone-800 transition-colors whitespace-nowrap"
          >
            Search
          </button>
        </form>
      ...
      {facts.length === 0 ? (
        <div className="text-center py-24">
          ...
          <Link href="/" className="text-xs font-semibold uppercase tracking-widest text-stone-500 hover:text-accent transition-colors">
            ← Back to homepage
          </Link>
        </div>
      ) : (
